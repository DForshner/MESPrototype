...
namespace Core.Web.Concurrency
{
    public class ConcurrencyAwareFilterAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(HttpActionContext actionContext)
        {
            ...
            {
                var concurrencyAware = aa as IVersioned;
                if (concurrencyAware != null)
                {
                    ...
                    try
                    {
                        ...
                        {
                            if (concurrencyAware.Version != ver)
        ...
        public override void OnActionExecuted(HttpActionExecutedContext actionExecutedContext)
        {
                ...
                actionExecutedContext.Response.Headers.ETag == null)
            {
                ...
                {
                    var concurrencyAware = objectContent.Value as IVersioned;

                    if (concurrencyAware != null)
                    {
                        if (concurrencyAware.Version != null)
                        {
                            var eTagString = Encrypt(concurrencyAware.Version.ToString(),
